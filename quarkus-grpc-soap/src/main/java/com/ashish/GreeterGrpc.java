...
public final class GreeterGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<com.ashish.HelloRequest, com.ashish.HelloReply> getSayHelloMethod;

    @io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/' + "SayHello", requestType = com.ashish.HelloRequest.class, responseType = com.ashish.HelloReply.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<com.ashish.HelloRequest, com.ashish.HelloReply> getSayHelloMethod() {
        io.grpc.MethodDescriptor<com.ashish.HelloRequest, com.ashish.HelloReply> getSayHelloMethod;
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
            synchronized (GreeterGrpc.class) {
                if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
                    GreeterGrpc.getSayHelloMethod = getSayHelloMethod = io.grpc.MethodDescriptor.<com.ashish.HelloRequest, com.ashish.HelloReply>newBuilder().setType(io.grpc.MethodDescriptor.MethodType.UNARY).setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello")).setSampledToLocalTracing(true).setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.ashish.HelloRequest.getDefaultInstance())).setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(com.ashish.HelloReply.getDefaultInstance())).setSchemaDescriptor(new GreeterMethodDescriptorSupplier("SayHello")).build();
                }
            }
        }
    ...
    public interface AsyncService {
        ...
        /**
         */
        default void sayHello(com.ashish.HelloRequest request, io.grpc.stub.StreamObserver<com.ashish.HelloReply> responseObserver) {
    ...
    public static class GreeterStub extends io.grpc.stub.AbstractAsyncStub<GreeterStub> {
        ...
        /**
         */
        public void sayHello(com.ashish.HelloRequest request, io.grpc.stub.StreamObserver<com.ashish.HelloReply> responseObserver) {
    ...
    public static class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
        ...
        /**
         */
        public com.ashish.HelloReply sayHello(com.ashish.HelloRequest request) {
    ...
    public static class GreeterFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterFutureStub> {
        ...
        /**
         */
        public com.google.common.util.concurrent.ListenableFuture<com.ashish.HelloReply> sayHello(com.ashish.HelloRequest request) {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch(methodId) {
                case METHODID_SAY_HELLO:
                    serviceImpl.sayHello((com.ashish.HelloRequest) request, (io.grpc.stub.StreamObserver<com.ashish.HelloReply>) responseObserver);
                    break;
                default:
    ...
    public static io.grpc.ServerServiceDefinition bindService(AsyncService service) {
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor()).addMethod(getSayHelloMethod(), io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<com.ashish.HelloRequest, com.ashish.HelloReply>(service, METHODID_SAY_HELLO))).build();
    }
    ...
    private static abstract class GreeterBaseDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier, io.grpc.protobuf.ProtoServiceDescriptorSupplier {
        ...
        public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
            return com.ashish.HelloGrpcProto.getDescriptor();
        }
